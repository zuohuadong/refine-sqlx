...
The MySQL adapter provides comprehensive MySQL database support for @refine-sqlx/orm using drizzle-orm as the underlying ORM. It supports both Bun and Node.js runtime environments with automatic driver selection.
...
```typescript
import { createMySQLProvider, createRefine } from '@refine-sqlx/orm';
...
```typescript
import { createMySQLProviderWithPool } from '@refine-sqlx/orm';
...
import { createMySQLProviderWithBunSql } from '@refine-sqlx/orm';
...
```typescript
import { ConnectionError, QueryError, ConfigurationError } from '@refine-sqlx/orm';
...
```typescript
import { testMySQLConnection } from '@refine-sqlx/orm';
...
The MySQL adapter is designed to be a drop-in replacement for other MySQL data providers in Refine applications. Simply replace your existing data provider with the @refine-sqlx/orm MySQL provider.
